<template>
    <div class="setting">
        ...
        <nya-container title="自定义 JS">
            <nya-input :value="$store.state.setting.js" fullwidth rows="5" type="textarea" autocomplete="off" placeholder="alert('欢迎使用 程源の工具箱')" @change="handleChange('setting.js', $event.target.value)" />
        </nya-container>
